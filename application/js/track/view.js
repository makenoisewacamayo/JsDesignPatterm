define([
  ...
  "utils/util"
    ...
    TrackView.prototype.render = function(data) {
        ...
        var className = data.isActive ? 'success' : '';
        ...
        if (this.isRendered) {
            ...
            this.$row = D$.create('tr', {
                parent: tracksContainer,
                className: className
            });
            D$.create('td', {
                parent: this.$row,
