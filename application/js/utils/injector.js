define([], function() {
    ...
    Injector.resolve = function(dependencies, fn) {
        return function() {
            ...
            require(dependencies, function() {
                ...
                var compositeArguments = dependenciesArguments.concat(fnArguments);
    ...
    Injector.validate = function(fn) {
        ...
        var separatedArguments = argumentsString.split(/\s*\,+\s/g);
        var argumentNames = separatedArguments.map(function(arg) {
            return arg.match(/^\w+/);
        });
        var argumentTypes = separatedArguments.map(function(arg) {
